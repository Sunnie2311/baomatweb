<?php require APPROOT . '/views/inc/header.php'; ?>
  <div class="row ">
      <div class="col-md-12">
          <a class="btn btn-primary float-right" href="<?php echo URLROOT ;?>/posts"><i class="fa fa-backward"></i> Go Back</a>
      </div>
        ...
        <div class="card mb-3 mt-2">
            ...
            <?php if($data['post']->user_id == $_SESSION['user_id']) : ?>
                <div class="row">
                    ...
                    <div class="col">
                        <form class="pull-right custom-btn" action="<?php echo URLROOT ;?>/posts/delete/<?php echo $data['post']->id ;?>" method="post">
                            <input type="submit" class="btn btn-danger btn-block text-center" value="Delete">
                        </form>
                    </div>
                </div>
            <?php endif ;?>
